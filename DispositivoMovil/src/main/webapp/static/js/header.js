const changeLangBtn = document.getElementById('changeTheme');

changeLangBtn.addEventListener('click', () => {
    const html = document.documentElement;

    // Cambia el valor de data-bs-theme a 'light' si es 'dark', y viceversa
    const newTheme = html.getAttribute('data-bs-theme') === 'dark' ? 'light' : 'dark';
    html.setAttribute('data-bs-theme', newTheme);

    // Cambia el ícono dependiendo del tema actual
    if (newTheme === 'dark') {
	...
	localStorage.setItem('themeSelected', newTheme);
});
...
const cerrarBuscador = document.getElementById('close-buscador');
