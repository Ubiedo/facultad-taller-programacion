  ...
  <div class="my-4">
    <div class="px-0justify-content-center">
		...
		<div class="container text-center">
    		<p class="custom-text mb-0 text-body-tertiary" style="display: none;">403</p>
    		<p class="error_url text-danger-emphasis ps-3" style="display: none;">(FORBIDDEN) ¿Estás de vivo? <a href="/ServidorWeb2/home">Volvé al inicio</a> y pensá en lo que hiciste</p>
		</div>
    </div>
  </div>
		<style>
