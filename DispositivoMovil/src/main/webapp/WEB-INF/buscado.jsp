...
<html lang="es" data-bs-theme="light">
    ...
    <body>
      ...
      <div class="content-fluid m-4">
	      ...
	      <div class="row d-flex flex-wrap justify-content-center">
		        <form class="d-flex my-3" role="search" action="${pageContext.request.contextPath}/buscar" method="POST">
		          <input class="form-control me-2" type="search" value="<%= buscado %>" name="buscado" placeholder="Buscar" aria-label="Buscar">
    ...
    <% if (objetos.size() > 0) {
        ...
        <a href="${pageContext.request.contextPath}/rutas/<%= objeto.getNombre() %>" class="me-4 mb-4">
            ...
            <div class="card bg-body border border-secondary-subtle rounded" style="width: 18rem; height: fit-content;">
                ...
                <div class="card-img-top bg-body-secondary elemento rounded-top d-flex justify-content-center align-items-center" style="height: 8rem;">
                    <!-- Icono -->
                    <% if (objeto.getType().equals("Ruta")) { %>
