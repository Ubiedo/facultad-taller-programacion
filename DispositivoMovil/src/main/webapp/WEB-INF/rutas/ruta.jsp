...
<body>
<style>
/* ESTO ES PARA QUE EL TEXTO APAREZCA BONITO DEBAJO DE LA IMAGEN*/
.flight-header {
    display: flex;
    flex-direction: row; 
    align-items: center;
...
<div class="container rounded mb-3">
    <div class="card">
        ...
        <div class="flight-header">
		    <div id="imagen" class="flight-section">
		        <!-- Imagen de ruta -->
		        <%if (!rutaVuelo.getImagen().equals("(Sin Imagen)")){
            		%>
		        
		        <img src="${pageContext.request.contextPath}/Imagenes?id=<%= rutaVuelo.getImagen()%>" 
		             style="max-width:300px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.4);"  
		             alt="foto ruta">
		             <%} %>
		    </div>
		    <div class="flight-title-container flight-section" id="ruta-titulo">
		        <!-- Nombre de ruta -->
...
<%
    	...
    	%>
		<div class="flight-video my-2 mx-2">
