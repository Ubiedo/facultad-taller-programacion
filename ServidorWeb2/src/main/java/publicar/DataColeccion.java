 ...
 *         <element name="ConjDataRutaAsiento" type="{http://publicar/}dataRutaAsiento maxOccurs="unbounded" minOccurs="0"/>
...
public class DataColeccion {
    ...
    @XmlElement(name = "ConjDataRutaAsiento", required = true)
    protected List<DataRutaAsiento> ConjDataRutaAsiento;
    ...
    public List<DataRutaAsiento> getConjDataRutaAsiento() {
        return this.ConjDataRutaAsiento;
    }

    public void setConjDataRutaAsiento(List<DataRutaAsiento> value) {
        this.ConjDataRutaAsiento = value;
    }
