  ...
  <div class="my-4">
    <div class="px-0justify-content-center">
		...
		<div class="container text-center">
    		<p class="custom-text mb-0 text-body-tertiary" style="display: none;">500</p>
    		<p class="error_url text-danger-emphasis ps-3" style="display: none;">ERROR DE NUESTRA PARTE :(</p>
		</div>
    </div>
  </div>
		<style>
