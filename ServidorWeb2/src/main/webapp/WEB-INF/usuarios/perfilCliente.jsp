            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="info" role="tabpanel" aria-labelledby="info-tab">
                ...
                <ul class="list-group list-group-hover list-group-striped">
                  ...
                  <li class="list-group-item" id="contraseña"><strong>Contraseña:</strong> <%= usuario.getContrasenhaC() %></li>
              ...
              <div class="tab-pane fade" id="editar" role="tabpanel" aria-labelledby="editar-tab">
                ...
                <div class="form-floating mb-2 mt-3">
                  <input type="text" value="<%=usuario.getContrasenhaC() %>" class="form-control" id="nueva-password" placeholder="Nuevo contraseña" name="nueva-password" required>
